            ...
            if (nivel == 1)
            {
                ...
                if (!mapa.getTransicionando())
                {
                    ...
                    if (!mapa.getTransicionando())
                    {
                        ...
                        if(movimientoMonedas.getElapsedTime().asSeconds() >= 0.2){
                            if(!sentidoMovMonedas){
              for(int i = 0; i < monedasNivel.size(); i++)
              {
                 monedasNivel[i].monedaSprite->setPosition(monedasNivel[i].monedaSprite->getPosition().x, monedasNivel[i].monedaSprite->getPosition().y - 5);
                 sentidoMovMonedas = true;
              }
           }
           else
           {
              ...
              {
                 monedasNivel[i].monedaSprite->setPosition(monedasNivel[i].monedaSprite->getPosition().x, monedasNivel[i].monedaSprite->getPosition().y + 5);
                 sentidoMovMonedas = false;
              }
           }
           movimientoMonedas.restart();
        }
