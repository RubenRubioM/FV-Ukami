...
public:
    ...
    void drawSigilo(sf::RenderWindow &window, sf::RectangleShape *, sf::RectangleShape *, bool);
    ...
    sf::Sprite getTextGameOver();
    sf::Sprite getTextGanado();
    virtual ~Hud();
...
private:
    ...
    sf::Sprite *spriteSigiloHud;
    sf::Sprite *spriteWINHud;
    sf::Sprite *spriteGOHud;
};
